...
import unmutedPicture from "@/Pictures/unmuted.png";
import mutedPicture from "@/Pictures/unmuted.png";
import shufflePicture from"@/Pictures/shuffle.png";

import QuizBackgroundMusic3 from"@/Sounds/QuizBackgroundMusic3.mp3";
import ThinkingTime from"@/Sounds/ThinkingTime.mp3";
...
function toggleSound() {
  ...
  if (volumeSlider.value == 0) {
    soundPic.value = mutedPicture;
  } else {
    soundPic.value = unmutedPicture;
  }
...
let playList = [
QuizBackgroundMusic3,
  ThinkingTime,
];
const audioSource = ref(playList[0]);
const soundPic = ref(unmutedPicture);
const shufflePic = ref(shufflePicture);
